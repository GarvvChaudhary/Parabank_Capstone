...
#    OPEN SAVINGS ACCOUNT
    ...
    Wait Until Element Contains    ${from_acc_dropdown}    ${checking_account_number}    timeout=30s
...
Transfer Funds Only
    ...
    Wait Until Element Is Visible    ${from_acc_dropdown}   10s
    Wait Until Element Contains    ${from_acc_dropdown}    ${src_account_id}    timeout=30s
    Click Element    ${from_acc_dropdown}
